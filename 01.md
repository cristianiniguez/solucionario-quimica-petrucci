...
23. Realice los siguientes cálculos y mantenga el número apropiado de cifras significativas en cada resultado.

    a. $(38,4 \times 10^{-3}) \times (6,36 \times 10^5) = 244 \times 10^2 \rightarrow 2,44 \times 10^4$

    b. Ver abajo:

    $$
    \frac{(1,45 \times 10^2) \times (8,76 \times 10^{-4})}{(9,2 \times 10^{-3})^2}
    = \frac{12,7 \times 10^{-2}}{85 \times 10^{-6}} = 1079,5 \times 10^4
    \rightarrow 1,08 \times 10^6
    $$

    c. $24,6 + 18,35 - 2,98 = 39,97 \rightarrow 40,0$

    d. Ver abajo

    $$
    (1,646 \times 10^3) - (2,18 \times 10^2) + [(1,36 \times 10^4) \times (5,17 \times 10^{-2})]
    $$

    $$
    = (1,646 \times 10^3) - (2,18 \times 10^2) + (7,03 \times 10^2)
    $$

    $$
    = (1,646 \times 10^3) - (0,218 \times 10^3) + (0,703 \times 10^3)
    $$
    ...
    $$
    \frac{-7,29 \times 10^{-4} + \sqrt{(7,29 \times 10^{-4})^2 + 4(1,00)(2,7 \times 10^{-5})}}{2 \times (1,00)}
    = \frac{-7,29 \times 10^{-4} + \sqrt{5,31 \times 10^{-8} + 10,8 \times 10^{-5}}}{2,00}
    $$

    $$
    = \frac{-7,29 \times 10^{-4} + \sqrt{0,00531 \times 10^{-5} + 10,8 \times 10^{-5}}}{2,00}
    = \frac{-7,29 \times 10^{-4} + \sqrt{10,8 \times 10^{-5}}}{2,00}
    $$

    $$
    = \frac{-7,29 \times 10^{-4} + \sqrt{1,08 \times 10^{-4}}}{2,00}
    = \frac{-7,29 \times 10^{-4} + 1,04 \times 10^{-2}}{2,00}
    $$

    $$
    = \frac{-0,0729 \times 10^{-2} + 1,04 \times 10^{-2}}{2,00}
    = \frac{0,97 \times 10^{-2}}{2,00} = 0,49 \times 10^{-2} = 4,9 \times 10^{-3}
    $$
